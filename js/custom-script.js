...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Close popup when clicking on <span> (x)
    closeBtn.onclick = closeContactPopup;
    ...
    setTimeout(openContactPopup, 5000);

    // Optionally, if you want to trigger the popup from a button:
    // const contactButton = document.getElementById('contactButton');
    // if (contactButton) {
    //     contactButton.onclick = openContactPopup;
    // }
});
